...
void ControlTask(void *argument) {
  ...
  { 
    ...
    float x_ref[] = {0.0f, 0.0f, -13.04f*3.1715f/180.0f, 0.0f}; // 目标状态向量
    float left_x_current[] = {left_Wheel_position, left_Wheel_Speed, imu660rb.angles.pitch*3.1415f/180.0f, imu660rb.angles.pitch_acc*3.1415f/180.0f}; // 当前状态向量
    float right_x_current[] = {right_Wheel_position, right_Wheel_Speed, imu660rb.angles.pitch*3.1415f/180.0f, imu660rb.angles.pitch_acc*3.1415f/180.0f}; // 当前状态向量
    ...
    right_vref =  left_vref; // 计算右轮速度参考值
