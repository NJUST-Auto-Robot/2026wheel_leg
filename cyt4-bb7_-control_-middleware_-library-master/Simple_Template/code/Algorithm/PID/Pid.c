...
/**
 *@bref. calculate delta PID and position PID for angle
 *@param[in] set?? target
 *@param[in] real	measure
 */
...
{
    PID_struct_init(&pid_speedl,POSITION_PID,1,0.1,0.5,0.1,0.1);
    PID_struct_init(&pid_speedr,POSITION_PID,1,0.1,0.5,0.1,0.1);    
    PID_struct_init(&pid_theta_turn, POSITION_PID, 1, 0, 0.15, 0, 0.0);
    PID_struct_init(&pid_theta_line, POSITION_PID, 0.2, 0, 0.02, 0, 0.005);
    PID_struct_init(&pid_distance, POSITION_PID, 15, 0, 0.4, 0.05, 0);
}